 ...
 * Coincidentally, this is the same for both models (Whisper and Silero VAD)
 */
 ...
 */
export const MIN_SILENCE_DURATION_MS = 2000;
...
/**
 * Maximum duration of audio that can be handled by Whisper
 */
